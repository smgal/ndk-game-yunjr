#ifndef _TIZEN_YOZORA_APP_H_
#define _TIZEN_YOZORA_APP_H_
...
//  The [TizenYozora]App class must inherit from the UiApp class,
//  which provides the basic features necessary to define a UI application.
 
class TizenYozoraApp
